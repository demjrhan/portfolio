...
export default function AboutMe(){
    ...
    return (
            <motion.section
                ...
                initial={{ height: 0 }}
                animate={{ height: inView ? "40vh" : 0 }}
                transition={{ type: 'spring', stiffness: 65, damping: 12 }}
            >
            <h1
                className="absolute bottom-0 right-0 text-[19.5vw] font-extrabold text-white/5 select-none leading-[0.8] text-right"
            >
                YALCIN<br/>DEMIRHAN
            </h1>
            <div className="relative flex flex-col items-center text-center max-w-4xl px-6">
                <h2
                    className="text-4xl md:text-5xl font-bold text-white relative z-10 mb-6">
                    Always curious, always learning. </h2>
